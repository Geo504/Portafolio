export const proyectsData = [
  {
    ...
    tecnologies: ["React", "Css", "Html", "Python", "Flask", "Mysql", "SocketIo"],
    link_github: 'https://github.com/Geo504/astro-date-app',
    link_demo: 'https://cosmos-app-1234.onrender.com'
  },
  {
    id: 5,
    img: 'https://i.ibb.co/92QQJYx/starwars-full.jpg',
    title: 'Star Wars Blog',
    description: 'A full-stack Star Wars blog featuring some of the favorite characters from the saga.',
    ...
    tecnologies: ["React", "Css", "Bootstrap", "Html","Python", "Flask", "Mysql"],
    link_github: 'https://github.com/Geo504/Star-Wars_API',
  ...
  },
  {
    ...
    title: 'Contact List',
    description: 'An agenda app to create your contacts list where you can add, edit, and delete any contact.',
  ...
  },
  {
    ...
    title: 'Star Wars Blog',
    description: 'A complete frontend project, connected with external APIs and modularized code.',
  ...
  },
  {
    ...
    title: 'Landing Page',
    description: 'A landing page created from zero using HTML, CSS, and Bootstrap.',
